...
fun getCodeForToolbarKey(key: ToolbarKey) = Settings.getInstance().getCustomToolbarKeyCode(key) ?: when (key) {
    ...
    VOICE_EDIT -> KeyCode.VOICE_EDIT_INPUT
...
enum class ToolbarKey {
    VOICE, VOICE_EDIT, CLIPBOARD, NUMPAD, UNDO, REDO, SETTINGS, SELECT_ALL, SELECT_WORD, COPY, CUT, PASTE, ONE_HANDED, FLOATING, SPLIT,
