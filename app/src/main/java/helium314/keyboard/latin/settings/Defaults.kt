...
object Defaults {
    ...
    const val PREF_VOICE_ENABLED = false
    const val PREF_VOICE_SHOW_KEYS = true
    const val PREF_VOICE_STREAMING = false
    const val PREF_VOICE_STT_URL = ""
    const val PREF_VOICE_STT_MODEL = ""
    const val PREF_VOICE_STT_KEY = ""
    const val PREF_VOICE_STT_FALLBACK_URL = ""
    const val PREF_VOICE_STT_FALLBACK_MODEL = "gpt-4o-mini-transcribe"
    val PREF_VOICE_STT_FALLBACK_KEY = BuildConfig.OPENAI_API_KEY
    const val PREF_VOICE_EDIT_URL = "https://api.openai.com"
    const val PREF_VOICE_EDIT_MODEL = "gpt-4o-mini"
    val PREF_VOICE_EDIT_KEY = BuildConfig.OPENAI_API_KEY
    const val PREF_VOICE_CA_CERT = ""
    const val PREF_VOICE_TIMEOUT = "10"
    const val PREF_VOICE_RETRIES = "1"
    const val PREF_VOICE_MAX_SECONDS = "0"
