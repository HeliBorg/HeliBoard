...
public final class Settings implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String PREF_VOICE_ENABLED = "voice_ai_enabled";
    public static final String PREF_VOICE_SHOW_KEYS = "voice_show_keys";
    public static final String PREF_VOICE_STREAMING = "voice_streaming";
    public static final String PREF_VOICE_STT_URL = "voice_stt_url";
    public static final String PREF_VOICE_STT_MODEL = "voice_stt_model";
    public static final String PREF_VOICE_STT_KEY = "voice_stt_key";
    public static final String PREF_VOICE_STT_FALLBACK_URL = "voice_stt_fallback_url";
    public static final String PREF_VOICE_STT_FALLBACK_MODEL = "voice_stt_fallback_model";
    public static final String PREF_VOICE_STT_FALLBACK_KEY = "voice_stt_fallback_key";
    public static final String PREF_VOICE_EDIT_URL = "voice_edit_url";
    public static final String PREF_VOICE_EDIT_MODEL = "voice_edit_model";
    public static final String PREF_VOICE_EDIT_KEY = "voice_edit_key";
    public static final String PREF_VOICE_CA_CERT = "voice_ca_cert";
    public static final String PREF_VOICE_TIMEOUT = "voice_timeout_seconds";
    public static final String PREF_VOICE_RETRIES = "voice_retries";
    public static final String PREF_VOICE_MAX_SECONDS = "voice_max_record_seconds";
