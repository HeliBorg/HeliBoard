...
object KeyCode {
    ...
    const val TOGGLE_AUTOSPACE =            -246
    const val TOGGLE_AUTO_CAP =             -247
    const val TOGGLE_FORCE_AUTO_CAP =       -248
    const val JOIN_NEXT =                   -249
    const val FORCE_NEXT_SPACE =            -250
    ...
    fun Int.checkAndConvertCode(): Int = if (this > 0) this else when (this) {
        ...
        TOGGLE_AUTO_CAP, TOGGLE_FORCE_AUTO_CAP, JOIN_NEXT, FORCE_NEXT_SPACE, FORWARD_DELETE, MOVE_START_OF_LINE, MOVE_END_OF_LINE,
